...
import { getDocumentationMarkdown } from "../../content/documentation";
import { useI18n } from "../../i18n/I18nProvider";

export default function DocumentationPage({ onNavigate, path, user }) {
  const { locale, messages } = useI18n();
  const copy = messages.documentation || {};
  const markdown = getDocumentationMarkdown(locale);
  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-[1240px] px-4 pb-20 pt-10 md:px-6">
      ...
      <article className="documentation-page mx-auto max-w-4xl">
